...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.studiomelonpie.tifb.js')
	...
	f = os.path.join(cwd,'Classes','ComStudiomelonpieTifbModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.studiomelonpie.tifb.js']
